...
app.post('/create-google-user', async (req: Request<{}, {}, GoogleUserBody>, res: Response) => {
...
app.post('/updateUserData', async (req: Request<{}, {}, UserProfileData & { uuid?: string }>, res: Response) => {
